...
<div id="sidebar" class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="stock_medicine.php" class="nav-item <?php echo ($current_page == 'stock_medicine.php') ? 'active' : ''; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <a href="supplier.php" class="nav-item <?php echo ($current_page == 'supplier.php') ? 'active' : ''; ?>">
            <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
